            ...
            <div>
                ...
                <Tabs tabs={tabs} activeTab={activeTab} onTabChange={handleTabChange}/>
                    {filteredData.map((person, index) => {
                        if (activeTab === 'Руководители' && person['Роль'] === 'руководство ') {
                            return (
                                <div key={index}>
                                    <CardCEO
                                        name={person['Имя']}
                        ...
                        } else if (activeTab === 'Сотрудники' && !(person['Роль'] === 'руководство ')) {
                            return (
                                <div key={index}>
                                    <Card
                                        name={person['Имя']}
                        ...
                        } else if (activeTab === 'Департаменты' && person['Роль'] === 'depart') {
                            return (
